                            ...
                            <table id="data_buku" class="display">
                                <thead>
                                    <tr>
                                     ...
                                     <th rowspan="2" width="15%">Lokasi</th>
                                  ...
                                  <?php 
                                    for ($i = 1; $i < 30; $i++) {
                                       ...
                                       <tr>
                                           ...
                                           <td>2015</td>
                                           <?php if ($i % 2 == 0): ?>
                                             <td align="center"><span class="btn btn-primary btn-xs">Rak 2 - Lantai 1</span></td>
                                             <?php else: ?>
                                              <td align="center"><span class="btn btn-primary btn-xs">Rak 1 - Lantai 2</span></td>
                                           <?php endif ?>
